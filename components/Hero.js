...
const HeroSection = () => {
    return (
      ...
      <div className="relative h-screen">
        ...
        <div className="h-fit w-full bg-emerald-800 skew-x-[165deg] relative left-[-20px] ">
          <h1 className="text-xl md:text-[5xl] font-bold mb-[32px] pl-[80px md:20] skew-x-[12deg]">Welcome to my website</h1>
          <p className="text-base md:text-[2xl] leading-7 w-[45ch] skew-x-[12deg] pl-[80px md:20]">
